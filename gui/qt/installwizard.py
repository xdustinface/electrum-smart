...
from electrum_smart.util import UserCancelled, InvalidPassword
from electrum_smart.base_wizard import BaseWizard, HWD_SETUP_DECRYPT_WALLET
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins, storage):
        ...
        self.setWindowTitle('Electrum-Smart  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
        ...
        self.set_icon(':icons/electrum-smart.png')
        self.show()
        self.raise_()
